...
####---- SetInputDelay list ----3
set_input_delay  -clock {TVP_CLK}  -clock_fall -min 0.00 [get_ports {TVP_HSYNC}]
set_input_delay  -clock {TVP_CLK}  -clock_fall -min 0.00 [get_ports {TVP_VIDEO[0] TVP_VIDEO[9] TVP_VIDEO[2] TVP_VIDEO[4] TVP_VIDEO[5] TVP_VIDEO[6] TVP_VIDEO[7] TVP_VIDEO[8] TVP_VIDEO[1] TVP_VIDEO[3]}]
set_input_delay  -clock {TVP_CLK}  -clock_fall -min 0.00 [get_ports {TVP_VSYNC}]
